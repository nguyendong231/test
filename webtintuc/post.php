...
$where='';
if(isset($_GET["cat"])) {
    $cat = intval($_GET["cat"]); // intval có tác dụng chuyển đổi một biến hoặc một giá trị sang kiểu số nguyên (integer)
    if($cat != 0) {
...
$limit = 3; // chỉ định hiển thị 3 bài viết trên một trang
      ...
      <div class="col-md-8">
        ...
        <ul class="pagination justify-content-center mb-4">
				...
				if ($current_page > 1 && $total_page > 1) {
				    echo '<li class="page-item"><a class="page-link" href="index.php?'.$link.'page='.($current_page-1).'">Older</a></li>';
				}
				...
				if ($current_page <$total_page && $total_page > 1) {
				    echo '<li class="page-item"><a class="page-link" href="index.php?'.$link.'page='.($current_page+1).'">Newer</a></li>';
				}
				?>
				</ul>
